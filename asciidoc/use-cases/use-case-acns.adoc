[#clause_use_case_acns,sdpi_offset=6]
...
[#clause_use_case_acns_technical_precondition]
...
[#clause_use_case_acns_scenarios]
==== Scenarios

[role=use-case-scenario,sdpi_scenario="New device is connected to network with AGW service"]
[oid-arcs=".1"]
...
[role=use-case-scenario,sdpi_scenario="The AGW service loses connectivity with the ICU devices"]
[oid-arcs=".2"]
...
[role=use-case-scenario,sdpi_scenario="The AGW service fails"]
[oid-arcs=".3"]
...
[role=use-case-scenario,sdpi_scenario="The Clinician Notification System loses connectivity with the AGW"]
[oid-arcs=".4"]
