[#clause_use_case_aars,sdpi_offset=7]
...
[#clause_use_case_aars_technical_precondition]
...
[#clause_use_case_aars_scenarios]
==== Scenarios
...
[role=use-case-scenario,sdpi_scenario="The Alert Recording System loses connectivity with the AGW"]
[oid-arcs=".4"]
