...
sdpi_include_transaction::DEV-48[actor-id="somds_medical_alert_consumer",initiator=optional,receiver=optional]
...
sdpi_include_transaction::DEV-48[actor-id=somds_medical_alert_consumer,initiator=required,receiver=required]
