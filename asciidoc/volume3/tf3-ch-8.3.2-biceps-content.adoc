...
The <<acronym_biceps>> standard, <<ref_ieee_11073_10207_2017_Cor1_2025>>, provides an extensive semantic model for all information exchanged between <<vol1_spec_sdpi_p_actor_somds_participant>> systems.  This section provides a general background for <<acronym_biceps>>-based content, including both what is unique to this standard (e.g., different from the <<term_classic_dim>>), and any extensions that are made by this SDPi standard.


.R0701
[sdpi_requirement#r0701,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
All <<vol1_spec_sdpi_p_actor_somds_participant>> systems shall fully implement the semantic content requirements in the <<ref_ieee_11073_10207_2017_Cor1_2025>> <<acronym_biceps>> standard.
====
...
This model, detailed in <<ref_ieee_11073_10207_2017_Cor1_2025>>, provides a basic set of objects and containment relationships for describing the information and services supported by a medical device.
...
NOTE:  A detailed description of this <<acronym_biceps>> description information model is beyond the scope of this specification.  Detailed information is available in the <<ref_ieee_11073_10207_2017_Cor1_2025>> standard and other materials identified in <<vol1_appendix_b_references>>.

[%noheader]
[%autowidth]
[cols="1"]
|===
a| *{standard_note}*: This version of the standard does not fully support profiles of all the elements in the descriptive model, including:

* Service Control Object (SCO) and Operations
* Battery objects

Additionally, only limited support for the *_AlertSystem_* (and related objects), and for the *_SystemContext_* types are provided in SDPi {gemini_standard_sdpi_revision_short}.
...
[cols="1"]
|===
a| *{standard_note}*:  This clause is intentionally left blank for this version.
...
See <<ref_ieee_11073_10207_2017_Cor1_2025>> for additional details.
...
.^| Gateway PARTICIPANT that provides, for example, ADT information or laboratory results (inbound). Note:  <<acronym_agw>> is for an <<label_system_type_name_agw>> system.  (For example, see <<clause_use_case_acns_technical_precondition>>)
...
.R0702
[sdpi_requirement#r0702,sdpi_req_level=shall,sdpi_req_type=tech_feature]
****
[NORMATIVE]
====
...
[cols="1"]
|===
a| *{standard_note}*:  The <<acronym_sdc>> standards community is evaluating the use of safety class elements in the BICEPS specification (see <<ref_ieee_11073_10207_2017_Cor1_2025>>), and the related https://github.com/IHE/DEV.SDPi/issues/11[Github Issue #11 _Topic: SDPi-xC with Mixed Device Safety Classes_].
...
* <<ref_ieee_11073_10207_2017_Cor1_2025>> Clause 8, especially R0109, R0200, R0203, and R0204, and
...
include::biceps-extension-provisions/extension-report-sequence.adoc[]
...
include::biceps-extension-provisions/tf3-ch-8.3.2.10.10-extension-inter-mds-relationship.adoc[]
